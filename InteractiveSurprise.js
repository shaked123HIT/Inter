...
lib.ssMetadata = [
		{name:"InteractiveSurprise_atlas_1", frames: [[1280,1114,290,403],[2028,0,15,170],[1359,1765,263,76],[0,0,1762,1112],[1077,1738,280,84],[839,1114,236,669],[358,1114,245,761],[1764,0,262,848],[1572,1114,130,375],[1590,1639,344,124],[1280,1519,308,217],[1077,1114,201,608],[605,1114,232,694],[1764,850,248,787],[0,1114,356,827]]}
];
...
(lib.CachedBmp_6 = function() {
	this.initialize(ss["InteractiveSurprise_atlas_1"]);
	this.gotoAndStop(0);
...
// stage content:
(lib.InteractiveSurprise = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/InteractiveSurprise_atlas_1.png", id:"InteractiveSurprise_atlas_1"}
	],
	preloads: []
};
